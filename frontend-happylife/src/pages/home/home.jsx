...
export default function Home() {
      ...
      <div class="bg-gray-100">
        <section class="cover #5576F5 relative bg-blue-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex
        items-center min-h-screen">
          <div class="h-full absolute top-0 left-0 z-0">
            <img src={Cover} alt="" class="w-full h-full object-cover opacity-20"></img>
          </div>
