            ...
            <div className='pt-20 pb-20 container mx-auto '>
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                    <div className="bg-white p-4  rounded-lg">
                        <img src={Insurance} alt="LOGO" className="rounded-lg" ></img>
                        <h5 className="pb-3 pt-5 pl-3 text-xl font-medium" >TITLE</h5>
                        <p className="pb-3 pl-3 text-xl">Decription</p>
                        <h5 className="pt-3 pl-3 text-xl font-medium text-custom-blue-3">Benefit</h5>
