    ...
    <div className='relative'>
      <div className='flex justify-center relative h-[317px] w-[1415px] bg-white rounded-lg border border-gray-200'>
        ...
        <div className="w-[504px] h-[296px] ml-[400px] pr-[106px] pt-[19px] pb-[102px] flex-col justify-start items-start gap-[21px] inline-flex">
            <div className="w-96 h-16 text-slate-900 text-[26px] font-medium font-['IBM Plex Sans'] leading-9">{props.planName}</div>
            <div className="w-[398px] h-[90px] text-slate-900 text-lg font-normal font-['IBM Plex Sans'] leading-[30px]">{props.planAbout}</div>
        </div>
        <div>   
            <div className="mt-[19px] mb-[19px] h-8 text-indigo-500 text-xl font-medium font-['IBM Plex Sans'] leading-9">Registration Date:  </div>
            <div className="w-[161px] h-12 py-3 bg-white rounded border border-neutral-200 justify-center items-center gap-[33px] inline-flex">{props.regisDate}</div>
